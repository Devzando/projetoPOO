...
public class HomeAdm extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HomeAdm frame = new HomeAdm(null);
	 ...
	 * Create the frame.
	 */
	public HomeAdm(Cliente loginCliente) {
		Cliente meuCliente;
		{
		...
		tabbedPane.addTab("Administrador", null, panel_2, null);
		panel_2.setLayout(null);
		
		JButton btnNewButton_4 = new JButton("Criar Produto");
		btnNewButton_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				CriarProduto screenCriarProduto = new CriarProduto(meuCliente);
				dispose();
				screenCriarProduto.setVisible(true);
				screenCriarProduto.setTitle("Criar Produtos");
			}
		});
		btnNewButton_4.setFont(new Font("Tahoma", Font.BOLD, 16));
		btnNewButton_4.setBounds(495, 153, 200, 73);
		panel_2.add(btnNewButton_4);
		
		JButton btnNewButton_4_1 = new JButton("Visualizar Relatório");
		btnNewButton_4_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Relatorio screenRelatorio = new Relatorio(meuCliente);
				dispose();
				screenRelatorio.setVisible(true);
				screenRelatorio.setTitle("Relatório Empresarial");
			}
		});
		btnNewButton_4_1.setFont(new Font("Tahoma", Font.BOLD, 16));
		btnNewButton_4_1.setBounds(152, 153, 200, 73);
		panel_2.add(btnNewButton_4_1);
		
		JButton btnNewButton_4_2 = new JButton("Deletar Produto");
		btnNewButton_4_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				DeletarProduto screenDeletarProduto = new DeletarProduto(meuCliente);
				dispose();
				screenDeletarProduto.setVisible(true);
				screenDeletarProduto.setTitle("Deletar Produto");
			}
		});
		btnNewButton_4_2.setFont(new Font("Tahoma", Font.BOLD, 16));
		btnNewButton_4_2.setBounds(152, 295, 200, 73);
		panel_2.add(btnNewButton_4_2);
		
		JButton btnNewButton_4_3 = new JButton("Atualizar Produto");
		btnNewButton_4_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		btnNewButton_4_3.setFont(new Font("Tahoma", Font.BOLD, 16));
		btnNewButton_4_3.setBounds(495, 295, 200, 73);
		panel_2.add(btnNewButton_4_3);
		
		JLabel lblNewLabel_7 = new JLabel("Bem vindo a aba adminstrador");
		lblNewLabel_7.setFont(new Font("Tahoma", Font.BOLD, 24));
		lblNewLabel_7.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_7.setBounds(203, 31, 470, 29);
